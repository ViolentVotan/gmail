...
| `CalendarLayout` | `hourRowHeight` (48), `timeColumnWidth` (50), `eventCardMinHeight` (24), `eventCardBorderWidth` (3), `currentTimeIndicatorHeight` (2), `currentTimeIndicatorDotSize` (8), `allDayEventHeight` (22), `miniMonthDaySize` (20), `miniAgendaMaxEvents` (5), `monthViewMaxEventsPerCell` (3), `monthEventChipHeight` (18), `monthSpanningBarHeight` (20), `monthMaxSpanningRows` (3), `todayCircleSize` (26). Used by `CalendarWeekView`, `CalendarDayView`, `CalendarMonthView`, and `CalendarEventCard` to ensure pixel-consistent layout across views. |
