...
New queries in `MailDatabaseQueries`: `calendars`, `visibleCalendars`, `allVisibleCalendars`, `eventsForDateRange`, `eventsForToday`, `eventWithAttendees`, `upcomingEventsWithParticipant`, `updateCalendarVisibility`, `calendarSyncToken`, `updateCalendarSyncToken`.
