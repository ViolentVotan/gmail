...
- `SmartReplyChipsView` — AI-generated reply suggestion chips below the thread (wired via `EmailDetailView`). Uses `.primary` foreground for strong contrast on glass capsules.
