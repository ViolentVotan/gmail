...
| `VikCommands` | macOS menu bar commands (File, Edit, View custom menus). `⌘1` / `⌘2` switch between Mail and Calendar view modes. `⌘N` is context-aware: opens compose in mail mode, opens `CalendarEventEditorView` in calendar mode. |
