...
- `SidebarView` — Conditional debug button (reads `@AppStorage("showDebugMenu")`). "Last synced: X ago" footer (driven by `AppCoordinator.lastRefreshedAt`, hidden when sync bubble is active).
